...
public class ControllerRest {
    ...
    public Moeda getBitcoin() {
        return com.ufsm.api.moedas.MoedaFactory.infoMoeda(EnumMoedas.BITCOIN);
    }
    
    @GetMapping("/CHZ")
    public Moeda getChiliz() {
        return com.ufsm.api.moedas.MoedaFactory.infoMoeda(EnumMoedas.CHILIZ);
    }
    
    @GetMapping("/LTC")
    public Moeda getLitecoin() {
        return com.ufsm.api.moedas.MoedaFactory.infoMoeda(EnumMoedas.LITECOIN);
    }
    
    @GetMapping("/XRP")
    public Double getXRP() {
        return com.ufsm.api.moedas.MoedaFactory.infoMoeda(EnumMoedas.XRP).getLast();
    }
    
    @GetMapping("/ETH")
    public Moeda getEthereum() {
        return com.ufsm.api.moedas.MoedaFactory.infoMoeda(EnumMoedas.ETHEREUM);
    }
}
